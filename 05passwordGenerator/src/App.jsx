     ...
     rounded-lg px-4 py-4 my-8 text-orange-500 bg-gray-700"
      >
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          <input
            type="text" value={password} className="outline-none
          w-full py-1 px-3" placeholder="password" readOnly
            ref={passwordRef}
          />
        ...
        <div className="flex items-center gap-x-1">
          <input
            type="checkbox" defaultChecked={charAllowed} id="characterInput"
            onChange={() => {
